...
OUTPUT_DIR = './images/noise_reduction'
...
def plot_noise_reduction(data, data_label, save_name, output_dir=OUTPUT_DIR):
...
def plot_all_noise_reduction(output_dir=OUTPUT_DIR):
    plot_noise_reduction(TIME_DATA['Noise Reduction'], 'Time', 'noise_reduction_time', output_dir)
